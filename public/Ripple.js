  ...
  return (function() {
  ...
  })()(
    {
      ...
      2: [
        ...
        { _process: 4, "base64-js": 1, buffer: 2, ieee754: 3, timers: 5 }
      ],
      3: [
        function(require, module, exports) {
          (function(
      ...
      5: [
        ...
        { _process: 4, buffer: 2, "process/browser.js": 4, timers: 5 }
      ],
      6: [
        function(require, module, exports) {
          (function(
            ...
            var Ripple = (function() {
              function Ripple(container) {
                ...
                this.minInterval = this.isRandom
                  ? _utils2.default.randomInterval(
                ...
                },
                {
                  ...
                  value: function strokeRipple() {
                    ...
                    if (this.rate - this.lastripple >= this.minInterval) {
                      if (this.isRandom) {
                        this.minInterval = _utils2.default.randomInterval(
                          this.params.interval[0],
                          this.params.interval[1]
                        );
                      }
                      ...
                      this.rippleLines.push({
                        ...
                        color: _utils2.default.getRgbColor(
                          this.params.rippleColor
                        )
                      });
                    ...
                    this.rippleLines = this.rippleLines.map(function(
                      line,
                      index
                    ) {
                      line.r += 1;
                      line.color[3] =
                        (_this.center - line.r) / (_this.center - _this.radius);
                      line.gapAngle =
                        Math.asin(_this.params.pointRadius / 2 / line.r) * 2;
                      line.startAngle =
                        _this.ripplePoints[index]["angle"] + line.gapAngle;

                      return line;
                    });

                    this.ripplePoints = this.rippleLines.map(function(
                      line,
                      index
                    ) {
                  ...
                  value: function strokeRippleLine() {
                    ...
                    this.rippleLines.forEach(function(line, index) {
                      ...
                      ctx.arc(
                        ...
                        line.r,
                        line.startAngle,
                        line.startAngle + 2 * Math.PI - line.gapAngle * 2
                      );
        ...
        { "./utils": 7, _process: 4, buffer: 2, timers: 5 }
      ],
      7: [
        function(require, module, exports) {
          (function(
